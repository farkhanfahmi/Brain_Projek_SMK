...
> Dashboard dedicated untuk role `card_admin` (role ini **sudah ada** sejak Fase 1, lihat ADR-008 & [[Projek/AbsenSI/06-Features/manajemen-kartu|manajemen-kartu.md]] — sebelumnya cuma didefinisikan wewenangnya di backend, belum punya UI/dashboard sendiri, praktiknya semua orang pakai akun admin pusat). Fitur ini murni membangun UI dedicated + mengaktifkan akun nyata untuk role yang sudah dirancang.

---

## 🎯 Konsep

- **Clone fitur, bukan role baru.** Menu manajemen kartu (registrasi, nonaktifkan, ganti kartu, riwayat, bulk import CSV, tap-to-assign — lihat [[Projek/AbsenSI/06-Features/manajemen-kartu|manajemen-kartu.md]] untuk daftar lengkap) di-clone ke dashboard `card_admin`, dengan wewenang **identik persis** dengan yang sudah final — tidak dipersempit maupun diperluas
...
## Fungsi yang Di-clone (referensi [[Projek/AbsenSI/06-Features/manajemen-kartu|manajemen-kartu.md]])
...
## 🔗 Lihat Juga
- [[Projek/AbsenSI/06-Features/manajemen-kartu|manajemen-kartu.md]] — spec lengkap fungsi kartu yang di-clone
- [[Projek/AbsenSI/03-User-Roles|03-User-Roles]] — definisi role `card_admin`
- [[Projek/AbsenSI/11-Decisions|ADR-008]] — role generik bukan identitas orang
