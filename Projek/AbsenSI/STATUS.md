...
| ---------------------------------------------------------------------------------------------------- | ---------------- | ------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------- | ---------------- | ---------------------------------------------------------------------------------- | --- |
| task-WEB-001 — Rename Menu "Jadwal" -> "Jam Masuk Sekolah" + Cabut Read Access admin_jurnal          | BELUM DIKERJAKAN | Tinggi (RBAC bocor)                   | Sonnet / low    | Audit menu Jadwal 2026-09-02: label "Jadwal" menyesatkan (isinya Jam Masuk Sekolah, bukan jadwal mengajar) + admin_jurnal punya READ access ke endpoint yang bukan domainnya — rename label + cabut RBAC.                                                                                                                                                    | 2026-09-02      | —                | `06-Features/tasks/task-WEB-001-rename-menu-jadwal-jam-masuk-sekolah.md`           |     |
| task-CORE-002 — Fix Silent-Fail Bentrok Guru di JadwalSlotService (Opsi B)                           | BELUM DIKERJAKAN | Sedang-Tinggi (integritas data)       | Sonnet / medium | Audit menu Jadwal 2026-09-02: `findBentrokConflict()` diam-diam anggap "tidak bentrok" saat gagal resolve jam guru lain — ubah jadi kategori "tidak bisa dipastikan" + warning eksplisit di dropdown guru, tanpa hard-block. **Harus dikerjakan sebelum task-CORE-003.**                                                                                     | 2026-09-02      | —                | `06-Features/tasks/task-CORE-002-fix-silent-fail-bentrok-guru-jadwal-slot.md`      |     |
| task-CORE-003 — Refactor N+1 Query di cekKetersediaanGuru                                            | BELUM DIKERJAKAN | Rendah-Sedang (performa, ada keluhan) | Sonnet / medium | Audit menu Jadwal 2026-09-02: dropdown guru di builder Jadwal Pelajaran lag di klik pertama (N+1 query per kandidat guru) — batch-kan query, hasil deteksi bentrok harus identik. **Depends on task-CORE-002.**                                                                                                                                              | 2026-09-02      | —                | `06-Features/tasks/task-CORE-003-refactor-n-plus-1-cek-ketersediaan-guru.md`       |     |
| task-CORE-004 — Pesan Error Jelas untuk teacherId Invalid di listSesiGuru                            | BELUM DIKERJAKAN | Rendah (quick win)                    | Haiku / low     | Audit menu Jadwal 2026-09-02: endpoint dropdown "Sesi Tertentu" (form izin guru, admin_jurnal) balik array kosong diam-diam kalau teacherId tidak valid — tambah validasi existence + pesan error jelas.                                                                                                                                                     | 2026-09-02      | —                | `06-Features/tasks/task-CORE-004-pesan-error-teacher-id-invalid-list-sesi-guru.md` |     |
